...
<head>
    ...
    <link rel="stylesheet" href="<?php echo site_url('wp-content/plugins/realtime-batpro/style/style_client.css'); ?>">
...
<body>
    ...
    <div class="bubble" id="bubble">
        ...
        <img src="<?php echo site_url('/wp-content/plugins/realtime-batpro/image/74-749108_download-png-ico-icns-facebook-messenger-round-icon-removebg-preview.png'); ?>" alt="Chat Bubble Icon">
    </div>
    <!-- Conteneur de chat -->
    <div class="container" id="container" style="display: none;">
        ...
        <div class="input-container">
            ...
            <label for="ImageInput" class="image-icon">
                <img src="<?php echo site_url('/wp-content/plugins/realtime-batpro/image/image.png'); ?>" alt="Image">
            </label>
